...
//	}
    ...
    public String toString(){
        ...
        for(int i=0;i<getNumSat();i++){
            ...
            out+="satType:"+ os.getSatType() +"  satID:"+ (int)os.getSatID()+"\tC:"+fd(os.getCodeC(0))
                    +" cP:"+fd(os.getCodeP(0))
                    ...
                    +" inUse:" + (os.inUse()? "Y":"N")
                    +lineBreak;
            out+="satType:"+ os.getSatType() +"  satID:"+ (int)os.getSatID()+"\tC:"+fd(os.getCodeC(1))
                    +" cP:"+fd(os.getCodeP(1))
                    +" Ph:"+fd(os.getPhaseCycles(1))
                    +" Dp:"+fd(os.getDoppler(1))
                    +" Ss:"+fd(os.getSignalStrength(1))
                    +" LL:"+fd(os.getLossLockInd(1))
                    +" LL2:"+fd(os.getLossLockInd(1))
                    +" inUse:" + (os.inUse()? "Y":"N")
                    +lineBreak;
        }
